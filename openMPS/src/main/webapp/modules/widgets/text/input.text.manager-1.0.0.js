...
function( Logger, BaroFloating, WidgetManagerBase, DefinitionsParams )
{
	...
	{
		template: "#input_text_manager_html",
		regions:
		{
		...
		_makeItemParams: function()
		{
			var seedParams = 
			{
				...
				prop : {
					...
					desc : '짧은 설명', 	// 부가 설명
					input_size : 'input-sm', // 폼 사이즈 표시 input-lg: 크게 / input-sm: 작게 / 없음은 보통! 
					label_size : 'label-sm', // 레이블 사이즈 표시 label-lg: 크게 / label-sm: 작게 / 없음은 보통! 
