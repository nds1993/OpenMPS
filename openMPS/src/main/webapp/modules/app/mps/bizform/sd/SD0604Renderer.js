 	...
 	var Renderer = WorkAreaRenderer2.extend(
 	{
	   ...
	   ,
		...
		onSelectRow: function(selected)
		{
			...
			if( selected )
			{
				Renderer.__super__.onQuery.call( this, activeTabId , {"params":{"strtDate": queryData.strtDate, "endDate": queryData.endDate, "partCode": queryData.partCode, "distCode": selected.data.distCode}} );
			}
		}
 	}
 	,
