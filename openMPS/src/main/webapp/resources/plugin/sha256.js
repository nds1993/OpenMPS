...
Sha256.hash = function(msg, options) {
    ...
    for (var i=0; i<N; i++) {
        ...
        for (var t=16; t<64; t++) {
            W[t] = (Sha256.o1(W[t-2]) + W[t-7] + Sha256.o0(W[t-15]) + W[t-16]) >>> 0;
        }
        ...
        for (var t=0; t<64; t++) {
            var T1 = h + Sha256.M1(e) + Sha256.Ch(e, f, g) + K[t] + W[t];
            var T2 =     Sha256.M0(a) + Sha256.Maj(a, b, c);
            h = g;
            g = f;
            f = e;
            e = (d + T1) >>> 0;
 ...
 * @private
 */
Sha256.M0  = function(x) { return Sha256.ROTR(2,  x) ^ Sha256.ROTR(13, x) ^ Sha256.ROTR(22, x); };
Sha256.M1  = function(x) { return Sha256.ROTR(6,  x) ^ Sha256.ROTR(11, x) ^ Sha256.ROTR(25, x); };
