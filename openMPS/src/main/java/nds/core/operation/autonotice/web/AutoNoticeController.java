package nds.core.operation.autonotice.web;
...
/**
 * <p>Title: AutoNoticeController</p>
...
@Controller
public class AutoNoticeController extends BaseController{
	  /** AutoNoticeService */
     ...
     * @param reponse
     */
    @RequestMapping("/operation/autonotice/oprat1400.do")
    public ModelAndView oprat0600(HttpServletRequest request, HttpServletResponse reponse) throws Exception {
		...
		String[] msgrUseYnCd = request.getParameterValues("msgrUseYnCd");
   	    ...
   	    // 화면
   		ModelAndView mav = new ModelAndView("operation/autonotice/oprat1400");
