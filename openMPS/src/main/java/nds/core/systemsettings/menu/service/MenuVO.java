...
public class MenuVO extends CommonObject {
    ...
    private String pastGubn;
    
    public String getPastGubn() {
		return pastGubn;
	}

	public void setPastGubn(String pastGubn) {
		this.pastGubn = pastGubn;
	}
	...
	public String getAgentWaitCount() {
		return agentWaitCount;
	}

	public void setAgentWaitCount(String agentWaitCount) {
		this.agentWaitCount = agentWaitCount;
	}
