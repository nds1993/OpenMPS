...
public class PopupWidgetSetVO extends CommonObject {
    ...
    private String dashboardsId;    //searchVO
    
    private String dashboardsNm;
    ...
    public String getDashboardsId() {
		return dashboardsId;
	}

	public void setDashboardsId(String dashboardsId) {
		this.dashboardsId = dashboardsId;
	}

	public String getDashboardsNm() {
		return dashboardsNm;
	}

	public void setDashboardsNm(String dashboardsNm) {
		this.dashboardsNm = dashboardsNm;
	}
