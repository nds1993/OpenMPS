...
/**
 * <p>Title: 클레임 불만유형을 자동으로 콤보박스를 구성하는 taglib</p>
 * <p>Description: </p>
 * <p>Copyright: Copyright (c) 2015-12-09</p>
 * <p>Company: NDS</p>
 * @author 박민
 * @version 1.0
 */
public class ClaimTypeComboTag  extends BodyTagSupport {
    ...
    public int doEndTag() throws JspException {
        ...
        {           
            ...
            Query = " select TYPE_CD as TYPE_CD, TYPE_NAME as TYPE_NAME from CLT_CLAIM_TYPE_CD where TYPE_GRAD_CODE='9' AND TYPE_DVN = '1'  AND LVL = '"+ lvl +"'";
            Query += " order by TYPE_CD asc ";
