 ...
 * @version 1.0
 */
public class PropResultTypeComboTag  extends BodyTagSupport {
    ...
    public int doEndTag() throws JspException {
        ...
        {           
            ...
            Query = " select LCLS as CD_TP, TYPE_CAT_NM as CD_KNM from CLT_PROP_RESULT_TYPE where USE_YN='Y' AND LVL = '"+ lvl +"'";
