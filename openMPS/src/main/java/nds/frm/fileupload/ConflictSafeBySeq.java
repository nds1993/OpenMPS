...
public class ConflictSafeBySeq{
    ...
    /**
     * LConflictSafeBySeq Class 생성자
     */
    public ConflictSafeBySeq() throws Exception {
    }

    /**
    * LConflictSafeBySeq Policy Class 에서는 아무런 기능도 수행하지 않는다.
    *
    * @param  file 저장 정책을 적용할 file 객체
    * @return  file 객체의 적합성 여부, as a boolean.
    */
