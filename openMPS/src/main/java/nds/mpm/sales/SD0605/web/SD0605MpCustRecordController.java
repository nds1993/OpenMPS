package nds.mpm.sales.SD0605.web;
...
/**
 * @Class Name :  SD0605MpCustRecordController
 *
 * @author MPM TEAM
 * @since 2017. 9. 11.
 * @version 1.0
 ...
 */
@Controller
@RequestMapping("/mpm/{corpCode}/sd0605/mpcustrecord")
public class SD0605MpCustRecordController extends TMMBaseController{

    @Resource(name = "SD0605mpCustRecordService")
    private SD0605MpCustRecordService mpCustRecordService;
    ...
    @RequestMapping(value="/tab1/{strtDate}/{lastDate}/{teamCode}/{salesman}",method=RequestMethod.GET)
    ...
    @RequestMapping(value="/tab2/{strtDate}/{lastDate}/{teamCode}/{salesman}",method=RequestMethod.GET)
