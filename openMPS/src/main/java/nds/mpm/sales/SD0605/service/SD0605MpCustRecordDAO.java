package nds.mpm.sales.SD0605.service;
...
@Repository("SD0605mpCustRecordDAO")
public class SD0605MpCustRecordDAO extends EgovAbstractDAO {
    ...
    public List<?> selectMpCustRecordList(MpCustRecordDefaultVO searchVO) throws Exception {
        return list("SD0605mpCustRecordDAO.selectMpCustRecordList_D", searchVO);
    }
    ...
    public int selectMpCustRecordListTotCnt(MpCustRecordDefaultVO searchVO) {
        return (Integer)select("SD0605mpCustRecordDAO.selectMpCustRecordListTotCnt_S", searchVO);
    }
    ...
    public List<?> selectDetailTab1MpCustRecordList(MpCustRecordDefaultVO searchVO) throws Exception {
        return list("SD0605mpCustRecordDAO.selectDetailTab1MpCustRecordList_D", searchVO);
    }

    public List<?> selectDetailTab2MpCustRecordList(MpCustRecordDefaultVO searchVO) throws Exception {
        return list("SD0605mpCustRecordDAO.selectDetailTab2MpCustRecordList_D", searchVO);
    }
}
