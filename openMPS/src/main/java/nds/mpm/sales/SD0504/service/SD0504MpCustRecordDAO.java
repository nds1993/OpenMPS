package nds.mpm.sales.SD0504.service;
...
@Repository("SD0504mpCustRecordDAO")
public class SD0504MpCustRecordDAO extends EgovAbstractDAO {
    ...
    public List<?> selectMpCustRecordList(MpCustRecordDefaultVO searchVO) throws Exception {
        return list("SD0504mpCustRecordDAO.selectMpCustRecordList_D", searchVO);
    }
    ...
    public int selectMpCustRecordListTotCnt(MpCustRecordDefaultVO searchVO) {
        return (Integer)select("SD0504mpCustRecordDAO.selectMpCustRecordListTotCnt_S", searchVO);
    }
    ...
    public List<?> selectDetailTab1MpCustRecordList(MpCustRecordDefaultVO searchVO) throws Exception {
        return list("SD0504mpCustRecordDAO.selectDetailTab1MpCustRecordList_D", searchVO);
    }
