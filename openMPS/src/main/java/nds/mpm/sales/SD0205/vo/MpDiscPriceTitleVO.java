...
/**
 * @Class Name : MpDiscPriceTitleVO.java
 * @Description : MpDiscPriceTitle VO class
 ...
 */
public class MpDiscPriceTitleVO extends MpDiscPriceTitleDefaultVO{
    ...
    public void setDiscTitle(java.lang.String discTitle) {
