...
@Repository("SD0603mpCustRecordDAO")
public class SD0603MpCustRecordDAO extends EgovAbstractDAO {
    ...
    public List<?> selectMpCustRecordList(MpCustRecordDefaultVO searchVO) throws Exception {
        return list("SD0603mpCustRecordDAO.selectMpCustRecordList_D", searchVO);
    }
    ...
    public int selectMpCustRecordListTotCnt(MpCustRecordDefaultVO searchVO) {
        return (Integer)select("SD0603mpCustRecordDAO.selectMpCustRecordListTotCnt_S", searchVO);
    }
    ...
    public List<?> selectDetailTab1MpCustRecordList(MpCustRecordDefaultVO searchVO) throws Exception {
        return list("SD0603mpCustRecordDAO.selectDetailTab1MpCustRecordList_D", searchVO);
    }

    public List<?> selectDetailTab2MpCustRecordList(MpCustRecordDefaultVO searchVO) throws Exception {
        return list("SD0603mpCustRecordDAO.selectDetailTab2MpCustRecordList_D", searchVO);
    }
}
