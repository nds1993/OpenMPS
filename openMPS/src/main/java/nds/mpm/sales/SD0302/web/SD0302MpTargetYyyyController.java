package nds.mpm.sales.SD0302.web;
...
@Controller
@RequestMapping("/mpm/{corpCode}/sd0302/mptargetyyyy")
public class SD0302MpTargetYyyyController extends TMMBaseController{

    @Resource(name = "SD0302mpTargetYyyyService")
    private SD0302MpTargetYyyyService mpTargetYyyyService;
