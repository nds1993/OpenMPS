package nds.mpm.sales.SD0609.web;
...
/**
 * @Class Name :  SD0609MpCustRecordController
 *
 * @author MPM TEAM
 * @since 2017. 9. 11.
 * @version 1.0
 ...
 */
@Controller
@RequestMapping("/mpm/{corpCode}/sd0609/mpcustrecord")
public class SD0609MpCustRecordController extends TMMBaseController{

    @Resource(name = "SD0609mpCustRecordService")
    private SD0609MpCustRecordService mpCustRecordService;
	 ...
	 * @exception Exception
	 */
    @RequestMapping(value="/head/{strtDate}/{lastDate}/{teamCode}/{searchCondition}",method=RequestMethod.GET)
    ...
    @RequestMapping(value="/tab1/{strtDate}/{lastDate}/{teamCode}/{proCode}/{searchCondition}",method=RequestMethod.GET)
    ...
    @RequestMapping(value="/tab2/{strtDate}/{lastDate}/{teamCode}/{proCode}/{searchCondition}",method=RequestMethod.GET)
