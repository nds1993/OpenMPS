...
@Repository("mpTargetYyyyDAO")
public class MpTargetYyyyDAO extends EgovAbstractDAO {
    ...
    public String insertMpTargetYyyy(MpTargetYyyyVO vo) throws Exception {
        return (String)insert("mpTargetYyyyDAO.insertMpTargetYyyy_S", vo);
    }
    ...
    public void updateMpTargetYyyy(MpTargetYyyyVO vo) throws Exception {
        update("mpTargetYyyyDAO.updateMpTargetYyyy_S", vo);
    }
    ...
    public void deleteMpTargetYyyy(MpTargetYyyyVO vo) throws Exception {
        delete("mpTargetYyyyDAO.deleteMpTargetYyyy_S", vo);
    }
    ...
    public MpTargetYyyyVO selectMpTargetYyyy(MpTargetYyyyVO vo) throws Exception {
        return (MpTargetYyyyVO) select("mpTargetYyyyDAO.selectMpTargetYyyy_S", vo);
    }
    ...
    public List<?> selectMpTargetYyyyList(MpTargetYyyyDefaultVO searchVO) throws Exception {
        return list("mpTargetYyyyDAO.selectMpTargetYyyyList_D", searchVO);
    }
    ...
    public int selectMpTargetYyyyListTotCnt(MpTargetYyyyDefaultVO searchVO) {
        return (Integer)select("mpTargetYyyyDAO.selectMpTargetYyyyListTotCnt_S", searchVO);
    }
