...
import nds.mpm.sales.SD0501.service.MpLastUnpaymentService;
...
@Service("mpLastUnpaymentService")
public class MpLastUnpaymentServiceImpl extends EgovAbstractServiceImpl implements
        MpLastUnpaymentService {
        
    private static final Logger LOGGER = LoggerFactory.getLogger(MpLastUnpaymentServiceImpl.class);
