package nds.mpm.sales.SD0604.web;
...
/**
 * @Class Name :  SD0604MpCustRecordController
 *
 * @author MPM TEAM
 * @since 2017. 9. 11.
 * @version 1.0
 ...
 */
@Controller
@RequestMapping("/mpm/{corpCode}/sd0604/mpcustrecord")
public class SD0604MpCustRecordController extends TMMBaseController{

    @Resource(name = "SD0604mpCustRecordService")
    private SD0604MpCustRecordService mpCustRecordService;
    ...
    @RequestMapping(value="/tab1/{strtDate}/{lastDate}/{teamCode}/{custCode}",method=RequestMethod.GET)
    ...
    @RequestMapping(value="/tab2/{strtDate}/{lastDate}/{teamCode}/{custCode}",method=RequestMethod.GET)
