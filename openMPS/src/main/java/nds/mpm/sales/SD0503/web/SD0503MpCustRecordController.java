package nds.mpm.sales.SD0503.web;
...
/**
 * @Class Name :  SD0503MpCustRecordController
 *
 * @author MPM TEAM
 * @since 2017. 9. 11.
 * @version 1.0
 ...
 */
@Controller
@RequestMapping("/mpm/{corpCode}/SD0503/mpcustrecord")
public class SD0503MpCustRecordController extends TMMBaseController{

    @Resource(name = "SD0503mpCustRecordService")
    private SD0503MpCustRecordService mpCustRecordService;
	 ...
	 * @exception Exception
	 */
    @RequestMapping(value="/detail/{strtDate}/{lastDate}/{teamCode}/{corpCode}/{userCode}",method=RequestMethod.GET)
