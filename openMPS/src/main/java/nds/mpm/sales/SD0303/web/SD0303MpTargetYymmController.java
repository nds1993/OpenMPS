package nds.mpm.sales.SD0303.web;
...
@Controller
@RequestMapping("/mpm/{corpCode}/sd0303/mptargetyymm")
public class SD0303MpTargetYymmController extends TMMBaseController{

    @Resource(name = "SD0303mpTargetYymmService")
    private SD0303MpTargetYymmService mpTargetYymmService;
	 ...
	 * @exception Exception
	 */
    @RequestMapping(value="/head/{targetYyyy}",method=RequestMethod.GET)
    ...
    @RequestMapping(value="/detail/{targetYyyy}/{teamCode}/{salesman}",method=RequestMethod.GET)
