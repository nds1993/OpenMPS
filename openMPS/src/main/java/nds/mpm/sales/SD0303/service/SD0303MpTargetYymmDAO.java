...
@Repository("SD0303mpTargetYymmDAO")
public class SD0303MpTargetYymmDAO extends EgovAbstractDAO {
    ...
    public List<?> selectMpTargetYymmList(MpTargetYymmDefaultVO searchVO) throws Exception {
        return list("SD0303mpTargetYymmDAO.selectMpTargetYymmList_H", searchVO);
    }
    ...
    public List<?> selectMpTargetYymmListD(MpTargetYymmDefaultVO searchVO) throws Exception {
        return list("SD0303mpTargetYymmDAO.selectMpTargetYymmList_D", searchVO);
    }
    ...
    public int selectMpTargetYymmListTotCnt(MpTargetYymmDefaultVO searchVO) {
        return (Integer)select("SD0303mpTargetYymmDAO.selectMpTargetYymmListTotCnt_S", searchVO);
    }
