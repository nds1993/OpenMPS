package nds.mpm.sales.SD0611.service.impl;
...
import nds.mpm.sales.SD0611.service.SD0611MpCustRecordDAO;
...
@Service("SD0611mpCustRecordService")
public class SD0611MpCustRecordServiceImpl extends EgovAbstractServiceImpl implements
        SD0611MpCustRecordService {
        
    private static final Logger LOGGER = LoggerFactory.getLogger(SD0611MpCustRecordServiceImpl.class);

    @Resource(name="SD0611mpCustRecordDAO")
    private SD0611MpCustRecordDAO mpCustRecordDAO;
