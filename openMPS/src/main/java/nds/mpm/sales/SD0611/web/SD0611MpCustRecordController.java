package nds.mpm.sales.SD0611.web;
...
import nds.mpm.sales.SD0611.service.SD0611MpCustRecordService;
...
/**
 * @Class Name :  SD0611MpCustRecordController
 *
 * @author MPM TEAM
 * @since 2017. 9. 11.
 * @version 1.0
 ...
 */
@Controller
@RequestMapping("/mpm/{corpCode}/sd0611/mpcustrecord")
public class SD0611MpCustRecordController extends TMMBaseController{

    @Resource(name = "SD0611mpCustRecordService")
    private SD0611MpCustRecordService mpCustRecordService;
    ...
    @RequestMapping(value="/detail/tab1/{strtDate}/{lastDate}/{teamCode}",method=RequestMethod.GET)
    ...
    @RequestMapping(value="/detail/tab2/{strtDate}/{lastDate}/{teamCode}",method=RequestMethod.GET)
