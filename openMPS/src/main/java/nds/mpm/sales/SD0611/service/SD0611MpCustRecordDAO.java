...
@Repository("SD0611mpCustRecordDAO")
public class SD0611MpCustRecordDAO extends EgovAbstractDAO {
    ...
    public List<?> selectMpCustRecordList(MpCustRecordDefaultVO searchVO) throws Exception {
        return list("SD0611mpCustRecordDAO.selectMpCustRecordList_D", searchVO);
    }
    ...
    public int selectMpCustRecordListTotCnt(MpCustRecordDefaultVO searchVO) {
        return (Integer)select("SD0611mpCustRecordDAO.selectMpCustRecordListTotCnt_S", searchVO);
    }
    ...
    public List<?> selectDetailTab1MpCustRecordList(MpCustRecordDefaultVO searchVO) throws Exception {
        return list("SD0611mpCustRecordDAO.selectDetailTab1MpCustRecordList_D", searchVO);
    }

    public List<?> selectDetailTab2MpCustRecordList(MpCustRecordDefaultVO searchVO) throws Exception {
        return list("SD0611mpCustRecordDAO.selectDetailTab2MpCustRecordList_D", searchVO);
    }
}
