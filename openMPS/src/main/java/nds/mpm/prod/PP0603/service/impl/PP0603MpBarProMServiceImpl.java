package nds.mpm.prod.PP0603.service.impl;
...
import nds.mpm.prod.PP0603.service.PP0603MpBarProMDAO;
...
@Service("PP0603mpBarProMService")
public class PP0603MpBarProMServiceImpl extends EgovAbstractServiceImpl implements
        PP0603MpBarProMService {
        
    private static final Logger LOGGER = LoggerFactory.getLogger(PP0603MpBarProMServiceImpl.class);

    @Resource(name="PP0603mpBarProMDAO")
    private PP0603MpBarProMDAO mpBarProMDAO;
