package nds.mpm.prod.PP0503.web;
...
/**
 * @Class Name :  PP0503MpBarProMController
 *
 * @author MPM TEAM
 * @since 2017.08.30
 * @version 1.0
...
@Controller
@RequestMapping("/mpm/{corpCode}/pp0503/mpbarprom")
public class PP0503MpBarProMController extends TMMBaseController {

    @Resource(name = "PP0503mpBarProMService")
    private PP0503MpBarProMService pP0503mpBarProMService;
	 ...
	 * @exception Exception
	 */
    @RequestMapping(value="/{strtDate}/{plantCode}",method=RequestMethod.GET)
    public ResponseEntity<ResultEx> selectMpBarProMList(
        ...
        List<?> mpBarProMList = pP0503mpBarProMService.selectMpBarProMList(searchVO);

    	PageSet pageSet = new PageSet();
        
        int totCnt = pP0503mpBarProMService.selectMpBarProMListTotCnt(searchVO);
	 ...
	 * @exception Exception
	 */
    @RequestMapping(value="/{strtDate}/{plantCode}/{proCode}",method=RequestMethod.GET)
    public ResponseEntity<ResultEx> selectMpBarProMList(
    		@PathVariable("corpCode") String corpCode,
    		@PathVariable("strtDate") String strtDate,
    		@PathVariable("plantCode") String plantCode,
        ...
        List<?> mpBarProMList = pP0503mpBarProMService.selectPopMpBarProMList(searchVO);
