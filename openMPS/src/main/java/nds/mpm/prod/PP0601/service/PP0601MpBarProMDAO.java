package nds.mpm.prod.PP0601.service;
...
@Repository("PP0601mpBarProMDAO")
public class PP0601MpBarProMDAO extends EgovAbstractDAO {
    ...
    public String insertMpBarProM(MpBarProMVO vo) throws Exception {
        return (String)insert("PP0601mpBarProMDAO.insertMpBarProM_S", vo);
    }
    ...
    public void updateMpBarProM(MpBarProMVO vo) throws Exception {
        update("PP0601mpBarProMDAO.updateMpBarProM_S", vo);
    }
    ...
    public void deleteMpBarProM(MpBarProMVO vo) throws Exception {
        delete("PP0601mpBarProMDAO.deleteMpBarProM_S", vo);
    }
    ...
    public MpBarProMVO selectMpBarProM(MpBarProMVO vo) throws Exception {
        return (MpBarProMVO) select("PP0601mpBarProMDAO.selectMpBarProM_S", vo);
    }
    ...
    public List<?> selectMpBarProMList(MpBarProMDefaultVO searchVO) throws Exception {
        return list("PP0601mpBarProMDAO.selectMpBarProMList_D", searchVO);
    }
    ...
    public int selectMpBarProMListTotCnt(MpBarProMDefaultVO searchVO) {
        return (Integer)select("PP0601mpBarProMDAO.selectMpBarProMListTotCnt_S", searchVO);
    }
