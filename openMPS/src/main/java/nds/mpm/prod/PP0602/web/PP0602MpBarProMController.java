package nds.mpm.prod.PP0602.web;
...
/**
 * @Class Name : PP0602MpBarProMController
 *
 * @author MPM TEAM
 * @since 2017.08.29
 * @version 1.0
...
@Controller
@RequestMapping("/mpm/{corpCode}/pp0602/mpbarprom")
public class PP0602MpBarProMController extends TMMBaseController {

    @Resource(name = "PP0602mpBarProMService")
    private PP0602MpBarProMService pP0602mpBarProMService;
	 ...
	 * @exception Exception
	 */
    @RequestMapping(value="/tab1/{strtDate}/{lastDate}/{plantCode}",method=RequestMethod.GET)
    public ResponseEntity<ResultEx> selectHeadTab1MpBarProMList(
        ...
        List<?> mpBarProMList = pP0602mpBarProMService.selectMpBarProMListTab1(searchVO);

    	PageSet pageSet = new PageSet();
        
        //int totCnt = pP0602mpBarProMService.selectMpBarProMListTotCnt(searchVO);
    ...
    @RequestMapping(value="/tab2/{strtDate}/{lastDate}/{plantCode}",method=RequestMethod.GET)
    public ResponseEntity<ResultEx> selectHeadTab2MpBarProMList(
    		@PathVariable("corpCode") String corpCode,
    		@PathVariable("strtDate") String strtDate,
    		@PathVariable("lastDate") String lastDate,
    		@PathVariable("plantCode") String plantCode,
        ...
        List<?> mpBarProMList = pP0602mpBarProMService.selectMpBarProMListTab2(searchVO);
