package nds.mpm.prod.PP0605.service.impl;
...
import nds.mpm.prod.PP0605.service.PP0605MpBarProMDAO;
...
@Service("PP0605mpBarProMService")
public class PP0605MpBarProMServiceImpl extends EgovAbstractServiceImpl implements
        PP0605MpBarProMService {
        
    private static final Logger LOGGER = LoggerFactory.getLogger(PP0605MpBarProMServiceImpl.class);

    @Resource(name="PP0605mpBarProMDAO")
    private PP0605MpBarProMDAO mpBarProMDAO;
    ...
    public List<?> selectMpBarProMListHead(MpBarProMVO searchVO) throws Exception {
        return mpBarProMDAO.selectMpBarProMListHead(searchVO);
    }
